	...
	<tbody>
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<div class="submit-buttons"><button type="submit" class="button sc-button" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>"><?php _e( 'Update Cart', 'woocommerce' ); ?></button><button type="submit" class="checkout-button button alt wc-forward sc-button" name="proceed" value="<?php _e( 'Proceed to Checkout', 'woocommerce' ); ?>">Paga<?php /*_e( 'Checkout', 'woocommerce' );*/ ?></button></div>
